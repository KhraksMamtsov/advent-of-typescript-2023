...
type FromLiteral<X extends number, N extends Num = []> = N['length'] extends X ? N : FromLiteral<X, [...N, 0]>
...
type FromBounds<From extends Num, To extends Num, R extends NumRange = [], Last extends Num = From> = Last extends To
  ? [...R, Last]
