...
test("day-21", () => {
  ...
  expectTypeOf<test_x_win_actual>().toEqualTypeOf<test_x_win_expected>();
  expectTypeOf<type_move5_actual>().toEqualTypeOf<type_move5_expected>();
  expectTypeOf<test_o_win_actual>().toEqualTypeOf<test_o_win_expected>();
  expectTypeOf<test_invalid_actual>().toEqualTypeOf<test_invalid_expected>();
